                ...
                <div className="card productDetailsSection">
                    <div className="row">
                        <div className="col-md-5">
                            <div className="sliderWrapper pt-3 pb-3 pl-4 pr-4">
                                ...
                                <Slider {...productSliderOptions} ref={productSliderBig} className="sliderBig mb-2">
                                    <div className="item">
                                        <img src="https://mironcoder-hotash.netlify.app/images/product/single/01.webp"
                                            className="w-100" />
                                    </div>
                                    <div className="item">
                                        <img src="https://mironcoder-hotash.netlify.app/images/product/single/01.webp"
                        ...
                        <div className="col-md-7">
                            <div className="pt-3 pb-3 pl-4 pr-4">
                                ...
                                <h4>Formal suits for men wedding slim fit
                                    3 piece dress business party jacket</h4>
                    ...
                    <div className="p-4">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            ...
                            Sit voluptatem delectus nam, molestiae, repellendus ab sint quo aliquam debitis
                            amet natus doloremque laudantium? Repudiandae, consequuntur, officiis quidem quo
                            ...
                            dolorem atque ratione voluptates asperiores maxime doloremque laudantium magni neque ad
                            ...
                            <div className="reviewsRow">
                                <div className="row">
                                    ...
                                    <p className="mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        ...
                                        autem recusandae? Eius harum tempora quis minima, adipisci natus quod magni
                                        omnis quas.</p>
                                </div>
                            </div>
