            ...
            <section className="loginSection signUpSection">
                ...
                <div className='row'>
                    ...
                    justify-content-center'>
                        <h1>BEST UX/UI FASHION <span className='text-sky'>ECOMMERCE DASHBOARD
                            </span> & ADMIN PANEL</h1>
                        ...
                        <div className='w-100 mt-4'>
                            <Link to={'/'}><Button className='btn-blue btn-lg 
                            btn-big'><IoMdHome />Go To Home</Button></Link>
                        </div>
                    </div>
                    ...
                    <div className='col-md-4 pr-0'>
                        <div className="loginBox">
                            ...
                            <div className='wrapper mt-3 card border'>
                                ...
                                your name' onFocus={() => focusInput(0)} onBlur={() => setInputIndex(null)} autoFocus/>
                                    </div>
                                ...
                                ${inputIndex === 1 && 'focus'}`}>
                                        ...
                                        <input type='text' className='form-control' placeholder='enter 
                                your email' onFocus={() => focusInput(1)} onBlur={() => setInputIndex(null)} />
                                    </div>
                                ...
                                your password' onFocus={() => focusInput(2)} onBlur={() => setInputIndex(null)} />
                                ...
                                ${inputIndex === 3 && 'focus'}`}>
                                        ...
                                        <input type={`${isShowConfirmPassword === true ? 'text' : 'password'}`} className='form-control' placeholder='confirm 
                                your password' onFocus={() => focusInput(3)} onBlur={() => setInputIndex(null)} />
