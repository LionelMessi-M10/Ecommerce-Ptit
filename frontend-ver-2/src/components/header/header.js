            ...
            <div className="headerWrapper" ref={headerRef}>
                        ...
                        <Link to={"/cart"}>
                          ...
                          Cart
                            ...
                            <div className="col-sm-5 part2">
                                <div
                                    className={`headerSearch d-flex align-items-center ${context?.isOpenSearch === true ? 'open' : ''}`}>
                ...
                {categories?.categoryList?.length !== 0 &&
                    categories?.categoryList !== undefined && (
                        <Nav data={categories?.categoryList} countryData={countryData.length !== 0 && countryData}
                             openNav={isOpenNav} closeNav={closeNav}/>
                    )}
            </div>
